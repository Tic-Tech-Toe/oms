  ...
  return (
    <div className="max-w-5xl mx-auto mt-20 px-4">
      <div className="mb-10">
        ...
        <h1 className="text-3xl font-semibold">Welcome, {(user.displayName?.split(' ')[0]) || 'Admin'}</h1>
        <ThemeSwitch />
        </div>
        <p className="text-muted-foreground mt-2">Manage users, invites and requests</p>
      </div>
      ...
      <div className="rounded-xl border bg-card p-6 mb-10 shadow-md">
        ...
        <div className="flex flex-col md:flex-row gap-4 items-start md:items-center">
          ...
          />
          <Button onClick={generateInvite} disabled={generating} variant="default" className='bg-light-primary'>
            {generating ? (
              <>
